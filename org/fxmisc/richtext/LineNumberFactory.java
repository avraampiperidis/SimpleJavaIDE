...
public class LineNumberFactory implements IntFunction<Node> {
    ...
    private static final Insets DEFAULT_INSETS = new Insets(0.0, 7.0, 0.0, 7.0);
    private static final Paint DEFAULT_TEXT_FILL = Color.web("#DBFFDB");
    private static final Font DEFAULT_FONT =
            Font.font("Consolas", FontPosture.ITALIC, 13);
    private static final Background DEFAULT_BACKGROUND =
            new Background(new BackgroundFill(Color.web("#2A2A2A"), null, null));
